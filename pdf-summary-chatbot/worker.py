...
Project_id= "skills-network" # This is the ID to use within the Skills network environemnt
...
def init_llm():
    ...
    os.environ["HUGGINGFACEHUB_API_TOKEN"] = "YOUR API KEY" # Need to get an API key
